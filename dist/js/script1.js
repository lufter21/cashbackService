		...
		function tId(st) {
			if (targetId) {
				...
				if (targetId == "header-mob-menu") {
					_$.css('top', $('.header').innerHeight());
					$('#header-top, .header__user-btn-mob').removeClass('toggled');
				}

				if (targetId == "header-top") {
					_$.css('top', $('.header').innerHeight());
					$('#header-mob-menu, .header__toggle').removeClass('toggled');
				}
