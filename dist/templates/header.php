...
<header id="header" class="header">
	<div class="header__row row row_wrp row_col-middle sm-row-col-12">
		<div class="col-3 p-y-0">
			<a href="index.html" class="header__logo"><img src="/images/bombonus.svg" alt="Dealers Air Bombonus"/></a>
		</div>
			...
			<div class="row row_col-middle sm-row-col-12">
				...
				<div class="col col_right p-0">
					...
					<div class="user">
						...
						<span class="user__thumb"><img src="images/avatar.png" alt="avatar"></span>
