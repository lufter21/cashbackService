...
<div class="popup">
	...
	<div id="alert-block" class="popup__window">
		...
		<div class="popup__inner">
			...
			<p>
				В вашем браузере установлено расширение, которое может нарушить работу нашего сайта, блокировать отображение элементов сайта.
			</p>
			<p>
				Проблема может быть вызвана блокировщиком рекламы. На нашем сайте нет рекламы, нашего сайта нет в черных списках, но расширение блокирует даже отображение логотипов магазинов.
			</p>
			<p>
				Отключите пожалуйста блокировщик рекламы на нашем сайте.
			</p>
		</div>
	</div>
