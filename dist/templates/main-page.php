<?php
$meta = array(
	'meta_title' => 'Скидки на заказ, подарки, бесплатная доставка от лучших интернет магазинов',
	'meta_description' => 'Используйте промокоды и покупайте со скидками в лучших интернет магазинах. Подарки к заказам. Бесплатная доставка.'
);
