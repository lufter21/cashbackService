...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Дек 30 2017 г., 22:12
...
(1, 'kompyuteri', 'Компьютеры', 'Компьютеры', 'Скидки на компьютеры', '', '', 15, 0, 0, '', '', '', '', 0, 0, 0, 'компьютер'),
(2, 'elektronika', 'Электроника', 'Электронику', 'Скидки на электронику', '', '', 15, 0, 0, '', '', '', '', 0, 0, 0, 'электрон'),
(3, 'avtotovari', 'Автотовары', 'Автотовары', 'Скидки на автотовары', '', '', 2, 0, 0, '', '', '', '', 1, 2, 0, 'автотовар'),
(4, 'odezhda', 'Одежда', 'Одежда', 'Скидки на одежду', '', '', 18, 0, 0, '', '', '', '', 1, 1, 0, 'одежд'),
(5, 'aksessuari', 'Аксессуары', 'Аксессуары', 'Скидки на аксессуары', '', '', 20, 0, 0, '', '', '', '', 1, 1, 0, 'аксессуар'),
(6, 'moda', 'Мода', 'Модные товары', 'Скидки на модные товары', '', '', 0, 0, 0, '', '', '', '', 0, 0, 0, 'мода'),
(7, 'krasota', 'Красота', 'Товары для красоты', 'Скидки на товары для красоты', '', '', 15, 0, 0, '', '', '', '', 1, 1, 0, 'красот'),
(8, 'zdorove', 'Здоровье', 'Товары для здоровья', 'Скидки на товары для здоровья', '', '', 15, 0, 0, '', '', '', '', 1, 1, 0, 'здоров'),
(9, 'detskie-tovari', 'Детские товары', 'Детские товары', 'Скидки и акции на детские товары от лучших интернет магазинов. Радуйте своих детишек и при этом экономьте', 'Акции и скидки на детские товары от самых хороших интернет магазинов. Все товары для детей отличного качества, а сэкономленные деньги - это очень приятно.', 'Привет всем:) Дети - цветы жизни. Их нужно любить и радовать, давать им самое лучшее. Но самое лучшее стоит хороших денег. Даже если вы не можете позволить себе покупать дорогие вещи для детей - это не беда, так как владельцы интернет магазинов тоже любят детей и частенько устраивают акции и скидки на товары для детишек. В этом разделе вы найдете акции и скидки на детские товары от самых хороших интернет магазинов. У нашей команды разработчиков так же есть семьи и дети и мы активно пользуемся данными скидками и акциями и с уверенностью можем сказать, что все товары для детей отличного качества, а сэкономленные деньги - это очень приятно. Радуйте своих малышей, активно используйте скидки и радуйтесь жизни.', 12, 0, 0, '', '', '', '', 1, 1, 0, 'дет'),
(10, 'dlya-doma', 'Для дома', 'Товары для дома', 'Скидки на товары для дома', '', '', 17, 0, 0, '', '', '', '', 1, 2, 0, 'дом'),
(11, 'obuv', 'Обувь', 'Обувь', 'Скидки на обувь', '', '', 16, 0, 0, '', '', '', '', 1, 1, 0, 'обув'),
(12, 'sportivnie-tovari', 'Спортивные товары', 'Спортивные товары', 'Скидки на спортивные товары', '', '', 24, 0, 0, '', '', '', '', 0, 0, 0, 'спорт'),
(13, 'chasi', 'Часы', 'Часы', 'Скидки на часы', '', '', 11, 0, 0, '', '', '', '', 0, 0, 0, 'часы'),
(14, 'turizm', 'Туризм', 'Туризм', 'Скидки на товары для туризма', '', '', 2, 0, 0, '', '', '', '', 0, 0, 0, 'туризм'),
(15, 'puteshestviya', 'Путешествия', 'Путешествия', 'Скидки на путешествия', '', '', 0, 0, 0, '', '', '', '', 0, 0, 0, 'путешеств'),
(16, 'igrushki', 'Игрушки', 'Игрушки', 'Скидки на игрушки', '', '', 10, 0, 0, '', '', '', '', 0, 0, 0, 'игр'),
(17, 'cveti', 'Цветы', 'Цветы', 'Скидки на цветы', '', '', 12, 0, 0, '', '', '', '', 0, 0, 0, 'цветы'),
(18, 'podarki', 'Подарки', 'Подарки', 'Скидки на подарки', '', '', 12, 0, 0, '', '', '', '', 0, 0, 0, 'подар'),
(19, 'zoo-tovari', 'ЗОО товары', 'ЗОО товары', 'Скидки на зоо товары', '', '', 5, 0, 0, '', '', '', '', 0, 0, 0, 'зоо'),
(20, 'bitovaya-tekhnika', 'Бытовая техника', 'Бытовая техника', 'Скидки на бытовую технику', '', '', 0, 0, 0, '', '', '', '', 1, 2, 0, 'бытов'),
...
(25, 'cifrovaya-tekhnika', 'Цифровая техника', 'Цифровая техника', 'Скидки на цифровую технику', '', '', 0, 0, 0, '', '', '', '', 1, 2, 0, 'цифров'),
(26, 'tovari-iz-kitaya', 'Товары из Китая', 'Товары из Китая', 'Скидки на товары из Китая', '', '', 0, 0, 0, '', '', '', '', 1, 1, 0, 'китая'),
...
(9, 'Цифровая & Бытовая техника, Красота & Здоровье, Подарки & Цветы', 'LANCOME', 'lancome', 'https://ad.admitad.com/g/aab245250b30b9bc50920559723564/', 'ru', '8,5%', 'http://export.admitad.com/ru/webmaster/websites/506206/coupons/export/?website=506206&advcampaigns=7651&code=4091f1232c&user=lufter&format=csv&v=4', '<p class=\"appr-time\">Среднее время подтверждения - 25 дней</p>', 1),
...
(22, 'Цифровая & Бытовая техника, Автотовары', 'КАРКАМ', 'karkam', 'https://ad.admitad.com/g/jztq3fgl6230b9bc5092ee6fec0cac/', 'all', '8,5%', 'http://export.admitad.com/ru/webmaster/websites/506206/coupons/export/?website=506206&advcampaigns=15173&code=4091f1232c&user=lufter&format=csv&v=4', '<p class=\"appr-time\">Среднее время подтверждения - 28 дней</p>', 1);
